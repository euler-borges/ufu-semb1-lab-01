...
para Linux. Foi instalada a versão 13.3
[arm-gnu-toolchain-13.3.rel1-x86_64-arm-none-eabi.tar.xz](https://developer.arm.com/-/media/Files/downloads/gnu/13.3.rel1/binrel/arm-gnu-toolchain-13.3.rel1-x86_64-arm-none-eabi.tar.xz).
...
```console
foo@bar$ sudo tar -xvf arm-gnu-toolchain-13.3.rel1-x86_64-arm-none-eabi.tar.xz -C /usr/share/
```
...
Para compleementar a instalação para a funcionalidade do arm-none-eabi-gdb, precisei instalar a seguinte biblioteca

```console
foo@bar$ sudo apt install libncursesw5
```
